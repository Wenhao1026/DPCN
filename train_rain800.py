...
from DerainDataset_rain800 import TrainValDataset
from utils import *
from torch.optim.lr_scheduler import MultiStepLR
from SSIM import SSIM
from PSA_SC import LMnet
import time
parser = argparse.ArgumentParser(description="model_train")
parser.add_argument("--batch_size", type=int, default=6, help="Training batch size")
parser.add_argument("--epochs", type=int, default=40, help="Number of training epochs")
parser.add_argument("--milestone", type=int, default=[105000,210000,315000], help="When to decay learning rate")
parser.add_argument("--lr", type=float, default=1e-3, help="initial learning rate")  # 1e-3
parser.add_argument("--save_path", type=str, default="D://zwh//model//PSA_SC_Rain800", help='path to save models and log files')
parser.add_argument("--save_freq", type=int, default=2100, help='save intermediate model')
parser.add_argument("--use_gpu", type=bool, default=True, help='use GPU or not')
parser.add_argument("--gpu_id", type=str, default="0", help='GPU id')
parser.add_argument("--iter_val", type=int, default=2100, help='iter val')
parser.add_argument("--iter_epoch", type=int, default=2, help='iter epoch')
...
def main():
    ...
    loader_val = DataLoader(dataset=dataset_val, num_workers=0, batch_size=opt.batch_size, shuffle=True, drop_last=True)
